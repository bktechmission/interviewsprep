...
public class LatLng implements Serializable
{
    ...
    private static final long serialVersionUID = 6520456651052916299L;
	...
	/**
	 * @return Returns a string of the form "lat,lng" for this LatLng. We round the lat/lng values to 6 decimal places
	 *         by default.
	 */
	...
	public boolean equals(Object o)
	{
		...
		if (lat != null ? !lat.equals(latLng.lat) : latLng.lat != null)
		{
			return false;
		}
		if (lng != null ? !lng.equals(latLng.lng) : latLng.lng != null)
		{
			return false;
		}
